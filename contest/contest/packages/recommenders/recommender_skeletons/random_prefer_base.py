...
are giving them a random score. Then we will add our bias from for the older/newer preference """
        ...
        recommendables = self.redis_con.zrangebyscore(self.z_itemList, self.currenttime - self.maximum_item_age,
            self.currenttime, withscores=True) ## this could download alot of items
