...
To make the computation of the bins fast we are using a continues query pattern
...
class DimensionListModel(baseModel):
    ...
    def __init__(self, dimensionName, mode):
        ...
        self.id_list = dict() # the dictionary which holds
...
if __name__ == '__main__':
    ...
    dL = DimensionListModel('user_ids', mode)
