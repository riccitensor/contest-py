...
if __name__ == '__main__':
    ...
    #c.insert('phonebook', 'key', {'first': 'John', 'last': 'Smith', 'phone': 12345})
    # print c.lookup('phonebook', 'jsmith4' )
    
    print [ x for x in c.search('phonebook', {'last' : 'Smith', 'phone' : ( 15000, 15004 ) } ) ]
