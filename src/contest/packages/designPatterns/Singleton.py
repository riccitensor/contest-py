...
"""
Singleton1 and Singleton2 are just for demonstration purposes
Singleton3 is in production use
...
#            print "Instance initialization ..."
            ...
            # lets try all hosts and check if we get a connection
            #for cassandra_host in config_local.cassandra_hosts:
            #    cls._inst.dbconn = cql.connect(cassandra_host, config_local.cassandra_port )
            cls._inst.dbconn = cql.connect(config_local.cassandra_host, config_local.cassandra_port )
            cls._inst.cursor = cls._inst.dbconn.cursor()
...
# 8168588 8176268
    ...
    class CassandraConTest(Singleton3):
        def __init__(self):
